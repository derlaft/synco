...
func (m *TimeChangeEvent) GetWhere() float64 {
	if m != nil {
		return m.Where
	}
	return 0
...
func (m *ReadyEvent) GetClientReady() bool {
	if m != nil {
...
func (m *GoEvent) GetPlayback() bool {
	if m != nil {
		return m.Playback
	}
	return false
...
func (m *HelloEvent) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *PingEvent) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
